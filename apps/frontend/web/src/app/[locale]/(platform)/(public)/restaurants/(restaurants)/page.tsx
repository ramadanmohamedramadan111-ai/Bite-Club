...
import { RestaurantCategory, RestaurantType } from '@/types/restaurant';
...
export default async function Page({ searchParams }: PageProps) {
  ...
  const { page = '1', category = '', minRating = '0', delivery, pickup, availableOnly, search = '', sort = 'rating' } = parsed.data;
      ...
      <div className="flex flex-col gap-8 lg:flex-row">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm text-muted-foreground mb-4">
            {totalItems}{' '}
            {totalItems === 1 ? t('restaurant') : t('restaurants_plural')}
          </p>
