export const ar: Record<string, any> = {
  ...
  invoices: {
    title: 'الفواتير',
    subtitle: 'إدارة وعرض فواتير المطاعم',
    ...
    platformDues: 'العمولات المشمولة',
    ...
    searchPlaceholder: 'بحث باسم المطعم أو المعرف...',
  },
  dashboard: {
    title: 'لوحة التحكم',
    ...
    pendingRestaurants: 'المطاعم المعلقة',
    periods: {
      today: 'اليوم',
      week: 'هذا الأسبوع',
      month: 'هذا الشهر',
  ...
  generalSettings: {
    ...
    subtitle: 'تكوين المعلمات الأساسية للمنصة',
    commissionRate: 'نسبة العمولة (%)',
    serviceFeeAmount: 'قيمة رسوم الخدمة ($)',
