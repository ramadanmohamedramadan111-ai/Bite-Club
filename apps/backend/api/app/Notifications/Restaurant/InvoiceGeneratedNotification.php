...
class InvoiceGeneratedNotification extends Notification implements ShouldQueue, ShouldBroadcast
{
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'title' => trans('notification.invoice_generated_title'),
            'body' => trans('notification.invoice_generated_body', [
