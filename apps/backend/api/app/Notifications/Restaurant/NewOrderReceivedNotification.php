...
class NewOrderReceivedNotification extends Notification implements ShouldQueue, ShouldBroadcast
{
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'title' => trans('notification.new_order_received_title'),
            'body' => trans('notification.new_order_received_body', ['order_id' => $this->order->id]),
