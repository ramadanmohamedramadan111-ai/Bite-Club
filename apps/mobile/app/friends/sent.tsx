...
import { useSentFriendRequests } from '@/lib/queries';
...
export default function SentRequestsScreen() {
  ...
  const query = useSentFriendRequests(page, PER_PAGE, search);
    ...
    <SafeAreaView style={[styles.safe, { backgroundColor: colors.background }]} edges={['top']}>
      ...
      <View style={styles.segmentedWrap}>
        <Segmented
          ...
          onChange={(value) => {
            ...
            if (value === 'received') router.replace('/friends/received');
      ...
      <ScrollView
        ...
        {query.isLoading ? (
          ...
          <View style={styles.center}>
            <Ionicons name="paper-plane-outline" size={40} color={colors.textSecondary} />
            <Text style={[styles.emptyText, { color: colors.textSecondary }]}>
              {t('friends.noSent')}
            </Text>
            <Text style={[styles.emptyDesc, { color: colors.textSecondary }]}>
              {t('friends.noSentDesc')}
            </Text>
          </View>
        ) : (
